...
export const useForm = (initialState = { distribution_id: null, report_time: '', report_frequency: "" }) => {
  ...
  const handleReportFrequency = (report) => {
  ...
  const handleSaveGroup = async (e) => {
    ...
    if(addReport) {
      ...
      const finalReportFrequency = report_frequency.join(',');

      const data = { portal_data: {
        report_type_id: `${report_type_id}`,
        distribution_id: `${distribution_id}`,
        report_time: report_time,
        report_frequency: finalReportFrequency,
      ...
      const finalReportFrequency = report_frequency.join(',');
      const finalGroup = { report_frequency: finalReportFrequency, ...rest };
  ...
  return { formValues: values, reset, emailError, reportNameError, handleReportFrequency, handleSaveGroup, setFormErrors, distributions, handleChangeDistribution, distributionSelected, onChangeReportTime, handleChangeReport, reportSelected, reports };
